...
class Openfile(QWidget):
    ...
    def initUI(self):
        ...
        elif self.OEM.currentText() == 'SYMC':
            for i in range(0,2):
                V_name = self.json_test[1]['vehicles'][i]['name']
                self.vehicle1.addItem(V_name)
            self.vehicle1.setCurrentText(self.settings.value('vehicles'))
            
        elif self.OEM.currentText() == 'LUCID':
            for i in range(0,2):
                V_name = self.json_test[2]['vehicles'][i]['name']
                self.vehicle1.addItem(V_name)
            self.vehicle1.setCurrentText(self.settings.value('vehicles'))
                
        elif self.OEM.currentText() == '"M&M"':
           self.vehicle1.setCurrentText(self.settings.value('vehicles'))
        ...
        elif self.vehicle1.currentText() == 'name1':
            self.scenario.addItem(self.json_test[1]['vehicles'][0]['can1'])
            self.scenario.addItem(self.json_test[1]['vehicles'][0]['can2'])
            self.scenario.setCurrentText(self.settings.value('scenario'))
            
        elif self.vehicle1.currentText() == 'name2':
            self.scenario.addItem(self.json_test[1]['vehicles'][1]['can1'])
            self.scenario.addItem(self.json_test[1]['vehicles'][1]['can2'])
            self.scenario.setCurrentText(self.settings.value('scenario'))
            
        elif self.vehicle1.currentText() == 'name3':
            self.scenario.addItem(self.json_test[2]['vehicles'][0]['can1'])
            self.scenario.addItem(self.json_test[2]['vehicles'][0]['can2'])
            self.scenario.setCurrentText(self.settings.value('scenario'))
            
        elif self.vehicle1.currentText() == 'name4':
            self.scenario.addItem(self.json_test[2]['vehicles'][1]['can1'])
            self.scenario.addItem(self.json_test[2]['vehicles'][1]['can2'])
            self.scenario.setCurrentText(self.settings.value('scenario'))
    ...
    def closeEvent(self, event):
        ...
        self.vehicle1.addItem(self.vehicle1.currentText())
        self.settings.setValue('vehicles',self.vehicle1.currentText())
        # print(self.settings3)
