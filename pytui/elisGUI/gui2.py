...
from PyQt5.QtWidgets import QApplication, QMainWindow, QPushButton, QWidget, QVBoxLayout, QHBoxLayout, QLabel, QLineEdit, QCheckBox
...
class GuiEILS(QMainWindow):
    ...
    def initUI(self):
        ...
        scenario_btn.setGeometry(10, 10, 130, 30)
        event_btn.setGeometry(150, 10, 100, 30)
        cyclic_start_btn.setGeometry(460, 10, 100, 30)
        cyclic_stop_btn.setGeometry(550, 10, 100, 30)
        ...
        for i in range(len(self.eventMessages)):
            ...
            check_btn_event.setGeometry(10, y_height_1, 200, 20)
        ...
        for i in range(len(self.eventsignal_list)):
            ...
            entry_event.setGeometry(180, y_height_2, 60, 20)
            label_signals = QLabel(self.eventsignal_list[i], self)
            label_signals.setGeometry(250, y_height_2, 200, 20)
        ...
        for i in range(len(self.cyclicMessages)):
            ...
            check_btn_cyclic.setGeometry(460, y_height_3, 200, 20)
        ...
        for i in range(len(self.cyclicsignal_list)):
            ...
            entry_cyclic.setGeometry(650, y_height_4, 60, 20)
            label_signals = QLabel(self.cyclicsignal_list[i], self)
            label_signals.setGeometry(720, y_height_4, 200, 20)
